import { $ as Facebook, A as Moon, B as Leaf, Ct as Award, F as Mail, H as Instagram, J as HeartHandshake, K as House, L as Lock, M as MessageCircle, O as Phone, Ot as Apple, P as MapPin, Q as FileHeart, S as Scale, St as Baby, T as Quote, Tt as ArrowRight, U as Image, W as Images, X as Flower2, Y as GraduationCap, _ as ShieldCheck, _t as Camera, a as Utensils, b as Send, bt as BookOpen, c as UserCheck, ct as Clock, dt as CircleCheck, et as Eye, f as Target, g as Sparkles, gt as ChartLine, h as Sprout, ht as Check, i as Video, it as Droplets, kt as Activity, lt as ClipboardList, m as Star, o as Users, p as Stethoscope, q as Heart, rt as Dumbbell, s as User, t as Youtube, ut as ClipboardCheck, vt as CalendarCheck, x as Search, xt as BadgeCheck, yt as Brain, z as Lightbulb } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-content-DISUfIbL.js
/**
...
function mergeContent(defaults, override) {
	if (override === void 0 || override === null) return defaults;
	if (Array.isArray(defaults) || Array.isArray(override)) return override ?? defaults;
	if (typeof defaults !== "object" || typeof override !== "object") return override ?? defaults;
	const out = { ...defaults };
	for (const [k, v] of Object.entries(override)) {
		if (v === void 0) continue;
		out[k] = k in defaults ? mergeContent(defaults[k], v) : v;
	}
	return out;
}
var NAVIGATION_DEFAULT = {
	...
	menuFooterText: "Your wellness is our priority. We're here to support you every step of the way.",
	menuFollowLabel: "Follow us"
};
var FOOTER_DEFAULT = {
	logo: IMG.logo,
	tagline: "Nourishing Hormones. Restoring You.",
	blurb: "Personalized nutrition & lifestyle care for hormone balance, metabolic health & overall well-being.",
...
var HOME_DEFAULT = {
	hero: {
		...
		subtitle: "Personalized nutrition and lifestyle care for PCOS, Thyroid, Diabetes, Infertility & Metabolic Health — guided by Dt. Kruthi Goud, MSc Clinical Nutrition.",
	...
	philosophy: {
		...
		items: [
			...
			},
			{
				icon: "Moon",
				title: "Sleep",
				sub: "Restore & recharge naturally"
			},
			{
				icon: "Dumbbell",
				title: "Movement",
				sub: "Build lasting metabolic health"
			},
			{
				icon: "Heart",
				title: "Hormones",
				sub: "Bring your body back to balance"
			}
		]
	},
	programs: {
	...
	testimonials: {
		...
		items: [
			{
				quote: "After years of irregular cycles and fatigue, Dt. Kruthi's personalized plan helped me restore my hormones naturally. I feel like a new me!",
				name: "— Anusha R.",
				program: "PCOS Program"
			},
			{
				quote: "My thyroid levels are now stable and I have more energy than ever. The guidance and support made all the difference.",
				name: "— Divya S.",
				program: "Thyroid Balance Program"
			},
			{
				quote: "We tried for years to conceive. With the right nutrition and support, we are now expecting our baby. Forever grateful!",
				name: "— Priya & Kiran",
	...
	gallery: {
		...
		images: [
			{
				img: IMG.gallery1,
				alt: "Reclaim Hormones community session 1"
			},
			{
				img: IMG.gallery2,
				alt: "Reclaim Hormones community session 2"
			},
			{
				img: IMG.gallery3,
				alt: "Reclaim Hormones community session 3"
			},
			{
				img: IMG.gallery4,
				alt: "Reclaim Hormones community session 4"
			},
			{
				img: IMG.gallery5,
				alt: "Reclaim Hormones community session 5"
			}
		]
	},
	cta: {
...
var ABOUT_DEFAULT = {
	...
	story: {
		...
		missionSub: "To empower individuals to reclaim their health through nutrition, sustainable habits, and compassionate care.",
		visionIcon: "Eye",
		visionTitle: "Our Vision",
		visionSub: "A world where everyone achieves hormonal balance, optimal health, and a life full of energy and confidence."
	},
	philosophy: {
		eyebrow: "Our Philosophy",
		items: [
	...
	clinic: {
		...
		items: [
			{
				img: IMG.clinicReception,
				caption: "Welcoming Reception"
			},
			{
				img: IMG.clinicConsultation,
				caption: "Consultation Room"
			},
			{
				img: IMG.clinicNutritionSession,
				caption: "Nutrition Sessions"
			},
			{
				img: IMG.clinicHealing,
	...
	values: {
		...
		items: [
			...
			},
			{
				icon: "Lightbulb",
				title: "Innovation",
				sub: "We embrace new ideas for better outcomes."
			},
			{
				icon: "Award",
				title: "Excellence",
	...
	approach: {
		...
		items: [
			...
			},
			{
				...
				icon: "UserCheck",
				title: "Personalize",
				sub: "Custom plans tailored just for you."
			},
			{
				n: "03",
				icon: "Users",
				title: "Transform",
				sub: "Balance, heal, and thrive naturally."
			},
			{
				n: "04",
				icon: "Leaf",
	...
	testimonials: {
		...
		items: [
			{
				quote: "Dt. Kruthi's personalized plan helped me regulate my cycles and lose weight naturally. I finally feel like myself again!",
				name: "— Sneha R."
			},
			{
				quote: "Finally found a nutritionist who truly listens and understands. Her guidance has been a life-changing experience.",
				name: "— Divya S."
			},
			{
				quote: "My energy, skin, and digestion have improved dramatically. Highly recommend Reclaim Hormones to everyone!",
				name: "— Priya & Kiran"
			}
		]
	},
...
var PROGRAMS_PAGE_DEFAULT = {
	...
	hero: {
		...
		points: [{
			icon: "Users",
			title: "For Women & Men",
			sub: "Specialized care for every stage of life."
		}, {
			icon: "ClipboardCheck",
	...
	approach: {
		...
		items: [
			...
			},
			{
				...
				sub: "Real transformations, lasting for life."
			}
		]
	},
	glimpses: {
		...
		items: [
			{
				img: IMG.gallery1,
				alt: "Dt. Kruthi Goud speaking at a health and wellness seminar"
			},
			{
				img: IMG.gallery2,
				alt: "Nutrition workshop with participants sharing a healthy meal"
			},
			{
				img: IMG.gallery3,
				alt: "Group photo from a women's health awareness event"
			},
			{
				img: IMG.gallery4,
				alt: "Wellness and nutrition conference session"
			}
		]
	},
	cta: {
...
var PROGRAM_SEED = [
	{
		...
		description: "Balance hormones, regulate cycles, improve ovulation, and manage symptoms naturally.",
	...
	{
		title: "Fertility & Reproductive Health",
		description: "Enhance fertility, regulate hormones, and support a healthy reproductive system.",
	...
	},
	{
		...
		description: "Navigate menopause smoothly and restore energy, mood, and hormonal balance.",
		...
		items: [
			{
				...
				quote: "My cycles were missing for months and nothing worked. The plan was simple, food-first and completely doable. I feel like myself again.",
				img: IMG.gallery2
			},
			{
				name: "Meghana, 34",
				...
				quote: "The fatigue and hair fall were the worst part. Six months in, my reports are normal and my energy is back all day.",
				img: IMG.gallery3
			},
			{
				name: "Rahul, 38",
				...
				quote: "No crash diets, no starvation. Just clear guidance and constant support. My doctor reduced my medication.",
				img: IMG.gallery4
			}
		]
	},
...
var TESTIMONIAL_SEED = [
	{
		name: "Anusha R.",
		program: "PCOS Program",
		rating: 5,
		review: "After years of irregular cycles and fatigue, Dt. Kruthi's personalized plan helped me restore my hormones naturally. I feel like a new me!",
		photo: "",
		order: 1
	},
	{
		...
		program: "Thyroid Balance Program",
		rating: 5,
		review: "My thyroid levels are now stable and I have more energy than ever. The guidance and support made all the difference.",
		photo: "",
		order: 2
	},
	{
		...
		program: "Fertility Support Program",
		rating: 5,
		review: "We tried for years to conceive. With the right nutrition and support, we are now expecting our baby. Forever grateful!",
		photo: "",
		order: 3
	}
];
var CONTACT_PAGE_DEFAULT = {
		...
		assurances: [
			{
				...
				sub: "Consult from anywhere in India."
			},
			{
				icon: "ShieldCheck",
	...
	form: {
		...
		disclaimer: "By submitting, you agree to be contacted about your enquiry. We never share your details.",
...
//#endregion
export { GALLERY_SEED as a, NAVIGATION_DEFAULT as c, TESTIMONIAL_SEED as d, icon as f, GALLERY_PAGE_DEFAULT as i, PROGRAMS_PAGE_DEFAULT as l, CONTACT_PAGE_DEFAULT as n, HOME_DEFAULT as o, mergeContent as p, FOOTER_DEFAULT as r, ICON_NAMES as s, ABOUT_DEFAULT as t, PROGRAM_SEED as u };
